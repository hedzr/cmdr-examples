...
const (
	appName   = "old-style"
	copyright = "old-style is an effective devops tool"
	desc      = "old-style is an effective devops tool. It make an demo application for `cmdr`."
	longDesc  = "old-style is an effective devops tool. It make an demo application for `cmdr`."
	examples  = `
